##asset file which can be used to clear all spawn eggs from players


#Spawn EGGS
clear @a frog_spawn_egg
clear @a spawn_egg
...
clear @a axolotl_spawn_egg
clear @a glow_squid_spawn_egg
clear @a goat_spawn_egg

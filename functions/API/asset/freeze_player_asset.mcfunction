#If player is staff
execute @s[tag=staffstatus] ~~~ tellraw @a[tag=staffstatus] {"rawtext":[{"text":"§¶§cUNITY API §b► §d"},{"selector":"@s"},{"text":" §¶§bis staff and can't be frozen."}]}
...
execute @s[tag=!staffstatus,scores={fzplr=1}] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cUNITY API §b► §d"},{"selector":"@s"},{"text":" §¶§bhas been §6frozen §bby a operator."}]}
...
execute @s[tag=!staffstatus,scores={fzplr=2}] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cUNITY API §b► §d"},{"selector":"@s"},{"text":" §¶§bhas been §6unfrozen §bby a operator."}]}

tellraw @s {"rawtext":[{"text":"§¶§cUNITY API §b► §¶§bSpawn Point has been set for §d"},{"selector":"@s"}]}
spawnpoint @s ~~~
...
tellraw @s {"rawtext":[{"text":"§¶§cUNITY API §b► §¶§bSpawn Set To§g X: "},{"score":{"name":"@s","objective":"X_Coordinate"}},{"text":" Y: "},{"score":{"name":"@s","objective":"Y_Coordinate"}},{"text":" Z: "},{"score":{"name":"@s","objective":"Z_Coordinate"}}]}
